"""
Django settings for tp_subject_form_validators project.
...
SECRET_KEY = '8j78=10cd4(=3!an7-66$hja_34!!iu%x)58iya_xzyxnlz=pg'
...
ROOT_URLCONF = 'tp_subject_form_validators.urls'
...
WSGI_APPLICATION = 'tp_subject_form_validators.wsgi.application'
